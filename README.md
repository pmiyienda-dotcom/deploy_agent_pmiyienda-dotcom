...
1. **Clone the repository:**
   git clone https://github.com/<your-username>/deploy_agent_<your-username>
...
1. **Directory Setup**
2. Create 'attendance_tracker_{input}/' with 'Helpers/' and 'reports/' subdirectories
3. **File Generation**
 Populates 'attendance_checker.py', 'Helpers/assets.csv', 'Helpers/config.json', and 'reports/reports.log'
4. **Config Update**
 Uses 'sed' to update Warning and Failure threshold values in 'config.json'
5. **Health Check** Runs `python3 --version` to verify Python is installed on the system
6. **Signal Handling** Catches `SIGINT` (Ctrl+C) and triggers the archive/cleanup routine
...
[Cleanup] Creating archive of current state and removing incomplete directory...
Incomplete project removed. Archive saved as attendance_tracker_1_archive.tar.gz
